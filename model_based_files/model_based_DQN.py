...
MODEL_NAME = "model_based_M5"#"128x128_world_models_net"#"Xception"
NR_OF_ACTIONS = 6
MEMORY_FRACTION = 0.3
MIN_REWARD = -200
SPAWN_NPC = True
...
class DQNAgent:
    ...
    def create_model(self):
        ...
        #model = keras.models.load_model('models/20_seconds__2.0000000000000013max_-0.1829999999999996avg_-0.9min__1586744631.model')
        #model = keras.models.load_model('models/MichealSchumacher__0.08max_-0.32499999999999996avg_-0.98min__1586122628.model')
        #model = keras.models.load_model('models/No_overfitting__0.07max_-0.352avg_-0.98min__1586705758.model')
        model.summary()
        return model
...
if __name__ == '__main__':
        ...
        #try:
            ...
            while True:
                ...
                # Every step we update replay memory
                    ...
                    """
                    if step % 2 == 0:
                        if len(recording_obs) <= 400:
                            recording_obs.append(pixel_obs)
                            recording_seg.append(seg_obs)
            ...
            if not episode % AGGREGATE_STATS_EVERY or episode == 1:
                ...
                #    agent.model.save("models/{}__{}max_{}avg_{}min__{}.model".format(MODEL_NAME, max_reward, average_reward, min_reward, int(time.time())))
                    agent.model.save("model_based_models/DQN_checkpoint.model")
            # Decay epsilon
    ...
    trainer_thread.join()
    agent.model.save("model_based_models/{}__{}max_{}avg_{}min__{}.model".format(MODEL_NAME, max_reward, average_reward, min_reward, int(time.time())))

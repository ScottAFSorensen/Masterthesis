...
from model_based_DQN import CarEnv, MEMORY_FRACTION
import spawn_npc
#import pandas
import csv
...
import math
import keras
#MODEL_PATH = 'model_based_models/model_based_1.model' #Tested and done
#MODEL_PATH = 'model_based_models/model_based_2.model' #Tested and done
#MODEL_PATH = 'model_based_models/model_based_3.model' #Tested and done
#MODEL_PATH = 'model_based_models/model_based_4.model' #tested and done
MODEL_PATH = 'model_based_models/model_based_5.model'

SPAWN_NPC = True
HD_CAM = True
#csv_name = "model_based_data_5_30sec_100cars.csv"
...
if __name__ == '__main__':
    ...
    while True:
        ...
        while True:
            ...
            #if (step % 150):
            #    path = 'comic_sequence/' + str(step) + '.png'

...
def encode_batch(batch_img):
  ...
  #print(simple_obs.shape)
  #print(simple_obs.shape[0])
  simple_obs = simple_obs.reshape(simple_obs.shape[0], 128, 128, 3)
...
def decode_batch(batch_z):
  ...
  batch_img = batch_img.reshape(batch_size, 128, 128, 3)
  return batch_img


# Hyperparameters for ConvVAE
z_size=64
batch_size=200#1000 # treat every episode as a batch of 1000!
learning_rate=0.001
kl_tolerance=0.5

...
acc1 = ea.EventAccumulator("final_follow_data/transfer_follow_model_logs/")
acc1.Reload()
#Load log 2 from scratch
#acc2 = ea.EventAccumulator("final_follow_data/7_sec_scratch_noboost_follow_model-1590595153/")
#acc2.Reload()
#Load log 3 from scratch
acc2 = ea.EventAccumulator("final_follow_data/scratch_follow_model_logs/")
acc2.Reload()
